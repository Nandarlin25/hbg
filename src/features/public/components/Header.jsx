...
//   const { headercontact } = useHeaderLinkStore();
//   const { navLinks, activeLink } = useHeaderNavStore();
//   const [currentHeaderContent, setCurrentHeaderContent] = useState(null);
...
//   // Click handler to simulate loading an image
//   const handleImageClick = () => {
//     setLoading(true);
//     // Simulate a delay for loading
//     setTimeout(() => {
//       // Replace with your logic to load the image
...
//   useEffect(() => {
//     // Update active link and current header content when location changes
//     updateActiveLink();

//     // Find the current header content based on the path
//     const content = headercontact.find(
//       (item) => item.path === location.pathname
//     );
//     setCurrentHeaderContent(content); // Update the state with current content
//   }, [location.pathname]); // Dependency on location.pathname
...
//               <Link
//                 to="/booking"
//                 className="text-primary bg-slate-100 dark:text-white hover:bg-gray-200 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800"
...
//             <img
//               src={`${currentHeaderContent.bgimage}?auto=format&fit=crop&w=800&h=600`}
//               alt="Background"
//               onLoad={handleImageLoad}
//               onError={handleImageError}
//               style={{ display: "none" }} // Hide the image as it's not used directly
//             />
//             <div
//               className="absolute inset-0 bg-cover bg-center bg-no-repeat"
//               style={{
//                 backgroundImage: loading
//                   ? `url('/path/to/loading-image.jpg')`
//                   : `url(${currentHeaderContent.bgimage}?auto=format&fit=crop&w=800&h=600)`,
//                 opacity: loading ? 0 : 1, // Show image only when loaded
//               }}
//             >
//               <div className="absolute inset-0 bg-opacity-40 bg-primary opacity-10"></div>
//               <div className="absolute bottom-36 text-center w-full flex flex-col">
//                 <div className="w-1/2 mx-auto px-4 py-5">
//                   {currentHeaderContent.title && (
//                     <h1 className="text-white text-4xl font-caveat font-bold py-3">
