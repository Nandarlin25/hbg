    ...
    <div className=" container mx-auto px-4 sm:px-6 lg:px-8  py-12">
      ...
      <div className="grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div>
          ...
          <div className="w-full h-64 sm:h-72 lg:h-[500px]">
            <iframe
        ...
        <div>
          ...
          <p className="font-normal lg:text-xl font-body mb-4 text-secondary  leading-relaxed sm:leading-normal sm:text-xs">
      ...
      <div className=" p-6  lg:mt-16 md:mt-14 ">
        ...
        <h2 className="lg:text-4xl font-bold font-heading  text-primary text-lg text-center ">
