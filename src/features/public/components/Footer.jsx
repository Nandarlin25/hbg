   ...
   <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
    ...
    <div className="">
      ...
      <div className="mt-4 flex space-x-4">
        ...
        <a href="#" className="hover:text-white"><i className="fa-brands fa-facebook-f text text-white text-lg"></i></a>
        </div>

        <div className="bg-zinc-950 size-10 flex justify-center items-center rounded-lg ">
        <a href="#" className="hover:text-white"><i className="fa-brands fa-instagram text text-white text-lg"></i></a>
        </div>

        <div className="bg-zinc-950 size-10 flex justify-center items-center rounded-lg">
        <a href="#" className="hover:text-white"><i className="fa-brands fa-twitter text text-white text-lg"></i></a>
        </div>
        
        <div className="bg-zinc-950 size-10 flex justify-center items-center rounded-lg">
        <a href="#" className="hover:text-white"><i className="fa-brands fa-linkedin-in text text-white text-lg"></i></a>
        </div>
      </div>
    </div>
  </div>
