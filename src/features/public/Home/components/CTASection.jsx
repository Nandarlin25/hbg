            ...
            <div className='bg-natural-light '>
              <div className='md:flex p-[26px] md:p-[62px] md:gap-2 lg:gap-5 justify-between items-center'>
                ...
                <div className='mx-auto mt-10 md:mt-0'>
                    <form action="" className='bg-secondary-card flex  md:w-[253px] lg:w-[400px] h-14 rounded-md justify-between '>
                        <input type="text"  className='bg-secondary-card border-secondary-card text-[14px] md:text-xs text-primary font-bold font-body' placeholder='Email Address...'/>
                        <button className='bg-primary text-primary-frame text-[12px] md:text-[11px] lg:text-[16px] rounded-md  py-1 m-3 px-1  w-[120px] md:w-[70px] lg:w-[120px] '>SUBSCRIBE</button>
                    </form>
                </div>
              </div>
            </div>
