    ...
    <div className="mt-16 md:mt-8 lg:mt-16">
      ...
      <div className=" bg-white p-[22px] ">
        ...
        <div className="pb-[22px]">
          <h2 className="text-md md:text-[11px] lg:text-md font-heading mt-2">
            BOOKING DETAILS
          </h2>
          <div className="flex gap-2 md:gap-0 lg:gap-2 items-center mt-4">
            {/* <input
                      type="checkbox"
                      className="size-3 lg:size-4 stroke-1 rounded-full checked:bg-primary pointer-events-none"
                      checked
                    /> */}

            <HiCheckCircle className="size-3 lg:size-4" />
          ...
          <div className="flex gap-2 md:gap-1 lg:gap-2 items-center  mt-4 md:mt-2 lg:mt-4">
            <HiUserCircle className="size-3 lg:size-4" />
          ...
          <div className="flex gap-2 md:gap-1 lg:gap-2 items-center mt-4 md:mt-2 lg:mt-4">
            <HiCalendar className="size-3 lg:size-4" />
            <span className="font-body text-lg  md:text-[12px] lg:text-[22px] ">
              Night: 1 Night
            </span>
          </div>
