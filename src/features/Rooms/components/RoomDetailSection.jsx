...
const RoomDetailSection = () => {
  ...
  return (
    <div>
      <div className='py-[20px] w-full bg-secondary-card overflow-hidden'>
        <Container>
          <section className='flex justify-between '>
              <ul className='flex gap-[40px] lg:pe-0 md:pe-0 sm:me-10 font-bold font-heading lg:text-[30px] md:text-[20px] sm:text-[14px] lg:leading-[47px] md:leading-[23px] sm:leading-[18px]'>
              ...
              <div className='flex items-center'>
                <p className='lg:text-[30px] md:text-[22px] font-bold lg:leading-[22px] lg:tracking-[0.32px] md:leading-[22px] md:tracking-[0.16px]'>$50 </p>
